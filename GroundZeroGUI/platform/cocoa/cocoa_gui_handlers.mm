#import "platform/cocoa/cocoa_gui_internal.h"
...
namespace persist = gz::gui::persist;
namespace shell = gz::gui::shell;
using gz::gui::platform::cocoa::collect_scans;
using gz::gui::platform::cocoa::cs;
using gz::gui::platform::cocoa::log_line;
using gz::gui::platform::cocoa::ns_to_utf8;
using gz::gui::platform::cocoa::run_up_async;
using gz::gui::platform::cocoa::save_ui;
using gz::gui::platform::cocoa::upgui_apply_open_panel_directory;
using gz::gui::platform::cocoa::utf8_to_ns;

@implementation GzGuiCtrl
...
- (void)doConfigure:(id)sender {
  ...
  const std::string cfg =
      shell::build_configure_args_line(cs().gz_exe, cwd, ns_to_utf8([cs().tf_build stringValue]), collect_scans(),
