...
// 与主窗、工具栏、菜单、环境对话框及 gz_gui.rc 图标 ID 对齐；由 win32_gui.cpp 匿名命名空间 `using` 引入。
namespace gz::gui::platform::win32::ids {

constexpr wchar_t kClassName[] = L"GzGuiMainClass";
constexpr wchar_t kTitle[] = L"gz-gui";

// Must match numeric id in GroundZeroGUI/resources/gz_gui.rc (RT_ICON).
enum : WORD { kGzGuiAppIconResourceId = 1 };
...
constexpr int IDM_GZ_HELP = 1002;
