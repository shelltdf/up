...
#include "platform/gtk/gtk_gui_window.hpp"
...
void gtk_application_activate(GtkApplication* app, gpointer) {
  ...
  log_line("gz-gui (GTK) — settings: " + gs().settings_file.generic_string());
}
