...
默认仅安装 COMPONENT gz_runtime：`bin/` 下 **gz、gz-gui、gz_reverse_cmake** 与 **gz_gui.png**；可选
...
def main() -> int:
    ...
    ap = argparse.ArgumentParser(
        ...
        epilog="说明：默认安装 gz_runtime（gz、gz-gui、gz_reverse_cmake、gz_gui.png）；加 --with-dev 时额外安装 gz.lib；与 test_projects 中的示例包无关。",
