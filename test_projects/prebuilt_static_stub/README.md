...
The import library is written to **`lib/import/stub_import.lib`** (MSVC). The repository includes this file so `up configure --scan test_projects` succeeds without an extra step on Windows x64 MSVC.
