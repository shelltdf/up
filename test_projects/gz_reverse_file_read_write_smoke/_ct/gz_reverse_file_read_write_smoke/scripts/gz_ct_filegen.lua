-- gz_reverse_cmake: filegen draft for target "gz_ct"
...
-- 同 Listfile 弱注记 (未执行):
--   [CMakeLists.txt:10] string REGEX MATCHALL x FRW_MATCHES ${FRW_BUF}
--   [CMakeLists.txt:11] string APPEND FRW_OUT x
--   [CMakeLists.txt:12] string CONCAT FRW_CONCAT a b
--   [CMakeLists.txt:13] foreach _i IN LISTS FRW_MATCHES
--   [CMakeLists.txt:16] while 0
