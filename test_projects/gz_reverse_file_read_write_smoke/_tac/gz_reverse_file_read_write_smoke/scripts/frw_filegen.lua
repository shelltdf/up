...
-- 同 Listfile 弱注记 (未执行):
--   [CMakeLists.txt:6] string REGEX MATCHALL x FRW_MATCHES ${FRW_BUF}
--   [CMakeLists.txt:7] string APPEND FRW_OUT x
--   [CMakeLists.txt:8] string CONCAT FRW_CONCAT a b
--   [CMakeLists.txt:9] foreach _i IN LISTS FRW_MATCHES
--   [CMakeLists.txt:12] while 0
